...
The same script also enforces the estate's no-em-dash rule, across prose and UI copy as well as code, so it scans `.md`, `.yml`, `.sh` and `.csv` in addition to source.
